...
#faasmctl cli.cpp --cmd "./bin/inv_wrapper.sh func.user rpc --clean func.upload-user rpc"
faasmctl cli.cpp --cmd "./bin/inv_wrapper.sh func.user snb --clean func.upload-user snb"
